  ...
  return (
    <div className="bg-gray-900 text-white">
      <div className="min-h-screen flex flex-col items-center px-4 pt-12 md:pt-40">
        ...
        {/* Frontend / Backend Cards (Centered) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-16 w-full max-w-4xl justify-items-center">
          {/* Frontend */}
          <div className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:scale-105 transition transform hover:rotate-1 w-full sm:w-[90%] md:w-[80%]">
            <h2 className="text-2xl font-semibold mb-4 text-blue-400 text-center">Frontend</h2>
          ...
          {/* Backend */}
          <div className="bg-gray-800 p-6 rounded-2xl shadow-lg hover:scale-105 transition transform hover:-rotate-1 w-full sm:w-[90%] md:w-[80%]">
            <h2 className="text-2xl font-semibold mb-4 text-green-400 text-center">Backend</h2>
            <p className="text-gray-300 text-center">
              Experienced in developing APIs and databases using Node.js, Express, and MongoDB.
            </p>
          </div>
